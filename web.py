...
app = Flask(__name__)
#pointing out the uploads folder for user uploaded optional photos of recipes. 
app.config['UPLOAD_FOLDER'] = 'static/uploads/' 

# Fetch user data to create a 'username to password' dictionary
...
#creating a username - password dictionary 
datab = {}
...
# Fetch user data to create a 'user_id to username' dictionary
user_query = "SELECT id, username FROM users;"
mycursor.execute(user_query)
user_data = mycursor.fetchall()

# Creating a dictionary mapping user_id to username
user_dict = {}
